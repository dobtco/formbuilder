...
function() {
    ...
    e = function(a) {
        ...
        return m(b, a), b.prototype.sync = function() {}, b.prototype.indexInDOM = function() {
            ...
            return null != c.inputFields[this.get(c.options.mappings.TYPE)]
        }, b
        ...
        return m(b, a), b.prototype.className = "fb-field-wrapper", b.prototype.events = {
            ...
            return this.$el.addClass("response-field-" + this.model.get(c.options.mappings.TYPE)).data("cid", this.model.cid).html(c.templates["view/base" + (this.model.is_input() ? "" : "_non_input")]({
                rf: this.model
            })), this
            ...
            var a;
            return a = _.clone(this.model.attributes), console.log(a), delete a.id, delete a.cid, a.label += " Copy", this.parentView.createField(a, {
        ...
        return m(b, a), b.prototype.className = "edit-response-field", b.prototype.events = {
            ...
            var b = this;
            return this.parentView = a.parentView, this.listenTo(this.model, "destroy", this.remove), _.each(c.options.change, function(a, d) {
                var e;
                return e = "change:" + c.options.mappings[d], b.listenTo(b.model, e, a)
            })
        }, b.prototype.render = function() {
            ...
            return this.parentView.editView = void 0, this.parentView.createAndShowEditView(this.model)
            ...
            var b;
            return b = $(a.currentTarget), "checkboxes" !== this.model.get(c.options.mappings.TYPE) && this.$el.find(".js-default-updated").not(b).attr("checked", !1).trigger("change"), this.forceRender()
        ...
        return m(e, a), e.prototype.SUBVIEWS = [], e.prototype.saveFormButton = $(), e.prototype.events = {
            ...
            return $(window).on("scroll", function() {
                var b, c;
                if (a.$fbLeft.data("locked") !== !0) return c = Math.max(0, $(window).scrollTop() - a.$el.offset().top), b = a.$responseFields.height(), a.$fbLeft.css({
            ...
            return this.$responseFields.hasClass("ui-sortable") && this.$responseFields.sortable("destroy"), this.$responseFields.sortable({
                ...
                stop: function(b, d) {
                    var e;
                    return d.item.data("type") && (e = a.collection.create(c.helpers.defaultFieldAttrs(d.item.data("type")), {
                        $replaceEl: d.item
                    }), a.createAndShowEditView(e)), a.handleFormUpdate(), !0
                },
                update: function(b, c) {
                    return c.item.data("type") ? void 0 : a.ensureEditViewScrolled()
                }
            }), this.setDraggable()
        }, e.prototype.setDraggable = function() {
            var a, b = this;
            return a = this.$el.find("[data-type]"), a.draggable({
            ...
            var b;
            return b = $(a.currentTarget).data("type"), this.createField(c.helpers.defaultFieldAttrs(b))
            ...
            var a;
            if (!this.formSaved) return this.formSaved = !0, this.saveFormButton.attr("disabled", !0).text(c.options.dict.ALL_CHANGES_SAVED), this.collection.sort(), a = this.getPayload(), c.options.HTTP_ENDPOINT && this.doAjaxSave(a), this.formBuilder.trigger("save", a)
        ...
        function b(b) {
            ...
            null == b && (b = {}), _.extend(this, Backbone.Events), c = _.extend(b, {
                formBuilder: this
            }), this.mainView = new a(c), this.mainView.collection
        }
        return b.helpers = {
            defaultFieldAttrs: function(a) {
                var c, d;
                return c = {}, c[b.options.mappings.LABEL] = "Untitled", c[b.options.mappings.TYPE] = a, c[b.options.mappings.REQUIRED] = !1, c.definition = b.fields[a], c.field_options = {}, ("function" == typeof(d = b.fields[a]).defaultAttributes ? d.defaultAttributes(c) : void 0) || c
            },
            ...
            ENABLED_FIELDS: ["text", "checkboxes", "dropdown", "paragraph", "radio", "date", "section_break", "signature", "info"],
            mappings: {
        ...
        }, b.fields = {}, b.inputFields = {}, b.nonInputFields = {}, b.prototype.markSaved = function() {
            return this.mainView.formSaved = !0
        }, b.prototype.getPayload = function() {
            return this.mainView.getPayload()
        }, b.registerField = function(a, c) {
            var d, e, f, g, h;
            for (d = !0, _.contains(b.options.ENABLED_FIELDS, a) || (d = !1), h = ["view", "edit"], f = 0, g = h.length; g > f; f++) e = h[f], c[e] = d ? _.template(c[e]) : function() {
                return ""
            };
            return c.type = a, c.enabled = d, b.fields[a] = c, "non_input" === c.type ? b.nonInputFields[a] = c : b.inputFields[a] = c
        }, b
    ...
    Formbuilder.registerField("dropdown", {
        ...
        defaultAttributes: function(a) {
            return a.field_options.options = [{
                ...
                checked: !1,
                score: ""
            }], a.field_options.include_scoring = !1, a.field_options.include_blank_option = !1, a
        }
    })
}.call(this),
...
function() {
    Formbuilder.registerField("info", {
        ...
        type: "non_input",
        view: "<label class='section-name'><%= rf.get(Formbuilder.options.mappings.LABEL) %></label>\n<p><%= rf.get(Formbuilder.options.mappings.DESCRIPTION) %></p>",
        edit: '<div class="fb-edit-section-header">Label</div>\n<div class="fb-common-wrapper">\n<div class="fb-label-description">\n  <input type="text" data-rv-input="model.<%= Formbuilder.options.mappings.LABEL %>">\n  <div class="summernote" data-bind-text="model.<%= Formbuilder.options.mappings.DESCRIPTION %>">\n      Yeah\n  </div>\n</div>\n</div>',
        addButton: '<span class="icon-info"></span> Info'
    })
}.call(this),
...
function() {
    Formbuilder.registerField("paragraph", {
        ...
        defaultAttributes: function(a) {
            return a.field_options.size = "small", a
        }
    })
}.call(this),
    ...
    Formbuilder.registerField("radio", {
        ...
        defaultAttributes: function(a) {
            return a.field_options.options = [{
                ...
                checked: !1,
                score: ""
            }], a.field_options.include_scoring = !1, a
        }
    })
}.call(this),
...
function() {
    ...
    with(obj) __p += (null == (__t = Formbuilder.templates["partials/left_side"]()) ? "" : __t) + "\n" + (null == (__t = Formbuilder.templates["partials/right_side"]()) ? "" : __t) + "\n<div class='fb-clear'></div>";
    return __p
    ...
    with(obj) __p += "<div class='fb-tab-pane active' id='addField'>\n  <div class='fb-add-types'>\n    <div class='section'>\n      ", _.chain(Formbuilder.inputFields).sortBy("order").filter(function(a) {
        return a.enabled
    }).each(function(a) {
        __p += '\n        <a data-type="' + (null == (__t = a.type) ? "" : __t) + '" class="' + (null == (__t = Formbuilder.options.BUTTON_CLASS) ? "" : __t) + '">\n          ' + (null == (__t = a.addButton) ? "" : __t) + "\n        </a>\n      "
    }), __p += "\n    </div>\n\n    <div class='section'>\n      ", _.chain(Formbuilder.nonInputFields).sortBy("order").filter(function(a) {
        return a.enabled
    }).each(function(a) {
        __p += '\n        <a data-type="' + (null == (__t = a.type) ? "" : __t) + '" class="' + (null == (__t = Formbuilder.options.BUTTON_CLASS) ? "" : __t) + '">\n          ' + (null == (__t = a.addButton) ? "" : __t) + "\n        </a>\n      "
    }), __p += "\n    </div>\n  </div>\n</div>";
    ...
    with(obj) __p += "<div class='subtemplate-wrapper'>\n  <div class='cover'></div>\n  " + (null == (__t = Formbuilder.templates["view/label"]({
        rf: rf
    })) ? "" : __t) + "\n\n  " + (null == (__t = Formbuilder.fields[rf.get(Formbuilder.options.mappings.TYPE)].view({
        rf: rf
    ...
    with(obj) __p += "<div class='actions-wrapper'>\n  <a class=\"js-duplicate " + (null == (__t = Formbuilder.options.BUTTON_CLASS) ? "" : __t) + '" title="Duplicate Field"><span class="icon-add"></span></a>\n  <a class="js-clear ' + (null == (__t = Formbuilder.options.BUTTON_CLASS) ? "" : __t) + '" title="Remove Field"><span class="icon-minus"></span></a>\n</div>';
    return __p
