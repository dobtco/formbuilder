...
Rivets.Binding = (function() {
  ...
  Binding.prototype.formattedValue = function(value) {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      formatter = _ref[_i];
      args = _.map(formatter.match(/\w+|"[^"]+"/g), function(arg) {
...
Rivets.binders = {
  ...
  value: {
    publishes: true,
    bind: function(el) {
      return this.currentListener = bindEvent(el, 'input change', this.publish);
    },
    unbind: function(el) {
      return unbindEvent(el, 'input change', this.currentListener);
    },
    routine: function(el, value) {
...
rivets.formatters.call = function(value, arg) {
  return console.log(value, arg);
};

rivets.formatters.then = function(value, arg) {
  if (value) {
    return arg;
  }
};
